...
func TestSummaryPreferencePrompt_Anchors(t *testing.T) {
	for _, want := range []string{
		"summarize durable experience rules",
		"owned by the human creator (not by any specific bot)",
		"concrete gotcha",
		"Only human signals count",
		"Keep rules only when they are evidence-backed, reusable, and executable",
		"Cancel reason",
		"Post-review",
		"Feedback (type=feedback)",
		"evidence must quote the human's original words verbatim",
		"- <self-explanatory imperative rule satisfying all four quality principles>",
		"  evidence: M-<seq>",
		"  scope: matter|project|global",
		"  avoid:",
		"  task_type:",
		"  underlying:",
		"Do not add headings, IDs, or explanations outside this structure",
		"Default to project when evidence comes from a single task",
		"NO_EXPERIENCE: 没有可复用的经验信号",
